...
public class PaqueteTest {
    ...
    public static void setUpClass() {
        ...
        //Otorgamos valores a las instancias
        dummy = new Paquete("paquete1", "descripcion1");
        dummyAgregar = new Paquete("paquete2", "descripcion2");
        dummyEliminar = new Paquete("paquete3", "descripcion3");
        
        //Registramos uno de los paquetes
        dummy.registrarPaquete();
        
        System.out.println(" --- INICIANDO PRUEBAS DE PAQUETE.JAVA --- ");
    }
    ...
    public static void tearDownClass() {
        ...
        System.out.println(" --- FINALIZANDO PRUEBAS DE PAQUETE.JAVA --- ");
    }
    ...
    public void testEliminarPaquete() throws Exception {
        ...
        dummyEliminar.registrarPaquete();
