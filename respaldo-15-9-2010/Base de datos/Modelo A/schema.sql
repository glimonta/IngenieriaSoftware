...
CREATE TABLE POSEE(
   ...
   CONSTRAINT VERIFICAR_FECHAS_POSEE CHECK (FECHA_FIN IS NULL OR
      FECHA_INIC < FECHA_FIN)
);
...
-- Calcula la factura de producto al afiliar un plan a este.



-- Calcula la factura de producto al agregar un servicio adicional a este.
...
-- Calcula la factura de producto al consumir servicios extra con un plan 
-- postpago.
